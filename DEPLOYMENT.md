...
> safe.
>
> **Cirrus dev deployment (`https://collab.cirrus.unleashlive.com`) is
...
> for the bootstrap recipe, plus `.github/workflows/deploy-cirrus.yml` in
> this repo for the deploy button.  The walkthrough below is the prod-
> oriented narrative; it still describes the same shape (ECS Fargate + ALB
> + EFS + Secrets Manager).
