...
export const FIELD =
  ...
  "text-12-regular text-text-strong outline-none placeholder:text-text-weaker " +
...
export const SEGMENT_ITEM_IDLE = "text-text-weak hover:text-text-strong"
...
export const CHIP_SELECT_OFF =
  "border-border-weak-base text-text-weak hover:bg-surface-base-hover hover:text-text-strong"

/** Quiet inline action rendered as text (Replace, Edit branch name, Retry). */
export const TEXT_ACTION =
  "inline-flex min-h-6 items-center rounded text-[11px] font-[500] text-text-weak " +
  "transition-colors duration-150 ease-out motion-reduce:transition-none " +
