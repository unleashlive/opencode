      ...
      <Show when={loading()}>
        <div class="fixed inset-0 z-[9999] flex flex-col items-center justify-center bg-background-base">
          <img
            ...
            alt="Unleash Collab"
            class="w-16 h-16 opacity-50 animate-pulse rounded-2xl"
          />
        </div>
      </Show>
    </>
  ...
  return (
    <div class="h-dvh w-screen flex flex-col items-center justify-center bg-background-base gap-6 p-6">
      <div class="flex flex-col items-center max-w-md text-center">
        <img src="/web-app-manifest-192x192.png?v=2" alt="Unleash Collab" class="w-12 h-12 mb-4 rounded-xl" />
...
function Routes(props: { serverScoped?: JSX.Element }) {
  ...
  return (
    <>
      {/* Collab standalone routes — skip the AppShell/server providers entirely */}
